...
const tr: PartialLocaleType = {
  ...
  Settings: {
    ...
    Mask: {
      Splash: {
        Title: "Maske Açılış Ekranı",
        SubTitle: "Yeni sohbete başlamadan önce bir maske açılış ekranı göster",
      },
    },
    Prompt: {
      Disable: {
  ...
  NewChat: {
    ...
    Skip: "Geç",
    Title: "Maske Seç",
    SubTitle: "Maskenin Arkasındaki Ruh ile Sohbet Edin",
    More: "Daha Fazla",
    NotShow: "Tekrar Gösterme",
    ConfirmNoShow: "Devre dışı bırakmayı onaylayın？Daha sonra ayarlardan etkinleştirebilirsiniz.",
  },
